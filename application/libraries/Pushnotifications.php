...
class Pushnotifications {
    ...
    public function __construct($options = array("instanceId" => "7a875a81-0a32-4474-aa9f-3064b42a2857", "secretKey" => "D1DE06AD6DE82E4DE9081BB39F994586E3B4FF020F6CBF653FA315E714A4E897")) {
    ...
    public function publish($interests, $publish_request) {
        ...
        if (!$success) {
            ...
            if ($bad_json || !ARRAY_KEY_EXISTS('error', $error_body) || !ARRAY_KEY_EXISTS('description', $error_body)) {
