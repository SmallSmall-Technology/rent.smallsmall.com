...
class UnioneClient
{
    ...
    public function emails(): UnioneApiEmail
    {
        return new UnioneApiEmail($this);
    }

    /**
     * @return Api\Template
     */
    public function templates(): UnioneTemplate
    {
        return new UnioneTemplate($this);
    }

    /**
     * @return Api\Webhook
     */
    // public function webhooks(): UnioneWebhook
    // {
    //     return new UnioneWebhook($this);
    // }
