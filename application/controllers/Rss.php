...
class Rss extends CI_Controller
{
	...
	public function insertDetails()
	{
		...
		log_message("debug", "Verification collected for User :: ". $details['profile'][0]['firstname']);

		log_message("debug", "Verification held for User :: ". $details['profile']);
...
value1&metadata[meta2]=value2*/
	...
	public function send_inactive_users_email(){
