			...
			<div class="page-title-wrapper">
				...
				<div class="page-title-heading">
					...
					<div class="page-title-icon">
						...
						<i class="pe-7s-signal icon-gradient bg-mean-fruit">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="main-card mb-3 card">
					...
					<div class="card-header">All Amenities
						...
						<table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tr>
										...
										<div class="widget-content-wrapper">
											...
											<div class="widget-content-left mr-3">
												...
												<div class="widget-content-left">
													...
													<img width="40" height="40" class="rounded-circle" src="<?php echo base_url()."uploads/amenity/"; ?><?php echo $pic; ?>" />
								...
								<td class="text-left">
									...
									<button type="button" id="article-<?php echo $value['id']; ?>" class="btn btn-primary btn-sm article-detail">Details</button>
