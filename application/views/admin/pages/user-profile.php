            	    ...
            	    <div class="app-main__inner">
            	        ...
            	        <div class="row">
                                        ...
                                        <tr>
            	                            ...
            	                            <tbody>
            	                                ...
            	                                <tr>
            	                                    ...
            	                                    <td><?php if (@$details['ref_count']) {
                                                            echo @$details['ref_count'];
                                                        } else {
                                                            echo 0;
                                                        } ?> persons</td>
            	                                </tr>
            	            ...
            	            <div class="col-lg-6">
            	                <div class="main-card mb-3 card">
            	                    <div class="card-body">
            	                        <h5 class="card-title">Debt Form</h5>
            	        ...
            	        <div class="row">
            	                                    ...
            	                                    <?php foreach ($bookings as $booking => $value) { ?>
            	                                        ...
            	                                        <tr class="prop-search-field prop-search-field-<?php echo $value['propertyID'] ?>">
            	                                            ...
            	                                            <td width="60%">
            	                                                ...
            	                                                <input type="text" class="form-control" placeholder="Property ID" id="prop-id-<?php echo $value['propertyID']; ?>" />
            	                                            </td>
            	                                        ...
            	                                        <tr class="prop-search-field prop-search-field-<?php echo $value['propertyID'] ?>">
            	                                            ...
            	                                            <td width="60%">
            	                                                ...
            	                                                <input type="text" class="form-control" placeholder="Security Deposit" id="security-dep-<?php echo $value['propertyID']; ?>" />
            	                                            </td>
            	            ...
            	            <div class="col-lg-6">
            	                <div class="main-card mb-3 card">
            	                    <div class="card-body">
            	                        <h5 class="card-title">Debt History</h5>
            	                        <table class="mb-0 table">
            	                        ...
            	                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
            	                            <thead>
            	                                <tr>
            	                                    ...
            	                                    <th width="300px" class="text-left">Action</th>
            	                                </tr>
            	                            </thead>
            	                                    ...
            	                                    <tbody>
                                                        ...
                                                        ?>
            	                                                ...
            	                                                <tr>
            	                                                    ...
            	                                                    <td class="text-left">
            	                                                        <div class="mb-2 mr-2 badge <?php echo $stat; ?>"><?php echo $value['payment_status']; ?></div>
            	                                                    </td>
            	                                                    <td class="text-left">
