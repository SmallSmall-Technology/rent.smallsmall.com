														...
														<div class="col-md-6">
															<div class="position-relative form-group  <?php if(@$property['payment_plan'] == 'no'){ echo 'payment-plan-period-spc';} ?>">
															    ...
															    <select class="form-control payment-plan-period">
																	...
																	<option <?php if(@$property['payment_plan_period'] == '1' || @$property['payment_plan_period'] == '12'){ echo 'selected = "selected"'; } ?> value="12">1 Year</option>
																	<option <?php if(@$property['payment_plan_period'] == '2' || @$property['payment_plan_period'] == '24'){ echo 'selected = "selected"'; } ?> value="24">2 Years</option>
																	<option <?php if(@$property['payment_plan_period'] == '3' || @$property['payment_plan_period'] == '36'){ echo 'selected = "selected"'; } ?> value="36">3 Years</option>
																	<option <?php if(@$property['payment_plan_period'] == '4' || @$property['payment_plan_period'] == '48'){ echo 'selected = "selected"'; } ?> value="48">4 Years</option>
																	<option <?php if(@$property['payment_plan_period'] == '5' || @$property['payment_plan_period'] == '60'){ echo 'selected = "selected"'; } ?> value="60">5 Years</option>
																	<option <?php if(@$property['payment_plan_period'] == '6' || @$property['payment_plan_period'] == '72'){ echo 'selected = "selected"'; } ?> value="72">6 Years</option>
																</select>
															</div>
														</div>
														
													</div>
													<div class="position-relative form-group"><label for="lockdownFee" class="">Lockdown Fee Percentage</label><input name="lockdownFee" id="lockdownFee" placeholder="Lockdown Fee" value="@$property['lockdown_fee']" type="text" class="form-control verify-field allFields"></div>
                                            	</div>
											</div>
                                        </div>
								<div class="card">
													    ...
													    <?php
																...
																?>
																			<span class="imgCover removal-id-<?php echo $count; ?>" id="id-<?php echo $file; ?>">
																				<img src="<?php echo $imgPath.''.$file; ?>" id="<?php echo $file; ?>" class="upldImg img-responsive img-thumbnail" onclick="selectFeatured(this.id)" title="Click to select as featured image" />
																				<?php if($file == $property['featured_image']){ echo '<span class="featTT">Featured</span>';} ?>
