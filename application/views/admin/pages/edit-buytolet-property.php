								...
								<div class="card">
									...
									<div data-parent="#accordion" id="collapseOne1" aria-labelledby="headingOne" class="collapse show">
										<div class="card-body">
											...
											<div class="position-relative form-group">
												<label for="lockdownFee" class="">Lockdown Fee Percentage</label>
												<input name="lockdownFee" id="lockdownFee" placeholder="Lockdown Fee" value="<?php echo @$property['lockdown_fee']; ?>" type="text" class="form-control verify-field allFields">
											</div>
											<div class="position-relative form-group">
												<label for="lockdownPeriod" class="">Lockdown Period</label>
												<input name="lockdownPeriod" id="lockdownPeriod" placeholder="Lockdown Period" value="<?php echo @$property['lockdown_period']; ?>" type="text" class="form-control allFields">
											</div>
											<div class="position-relative form-group">
												<label for="rentPerAnnum" class="">Rent Per Annum</label>
												<input name="rentPerAnnum" id="rentPerAnnum" placeholder="Rent Per Annum" value="<?php echo @$property['rent_per_annum']; ?>" type="text" class="form-control allFields">
											</div>
										</div>
									</div>
								</div>
