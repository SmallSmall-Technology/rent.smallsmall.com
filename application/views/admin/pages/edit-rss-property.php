				...
				<div class="main-card mb-3 card">
					...
					<div class="card-body">
						...
						<form method="POST" autocomplete="off" id="editPropForm" enctype="multipart/form-data">
								...
								<div class="form-row">
									...
									?>
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" <?php if (in_array("Male", $renter)) {
																																						echo 'checked="checked"';
																																					} ?> class="form-check-input" name="suitable-for[]" value="Male">Male</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" <?php if (in_array("Female", $renter)) {
																																						echo 'checked="checked"';
																																					} ?> class="form-check-input" name="suitable-for[]" value="Female">Female</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" <?php if (in_array("Family", $renter)) {
																																						echo 'checked="checked"';
																																					} ?> class="form-check-input" name="suitable-for[]" value="Family"> Family</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" <?php if (in_array("Corporate", $renter)) {
																																						echo 'checked="checked"';
																																					} ?> class="form-check-input" name="suitable-for[]" value="Corporate">Corporate</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" <?php if (in_array("Other", $renter)) {
																																						echo 'checked="checked"';
																																					} ?> class="form-check-input" name="suitable-for[]" value="Other"> Other</label></div>
											</div>
									...
									<?php } else { ?>
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="suitable-for[]" value="Male">Male</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="suitable-for[]" value="Female">Female</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="suitable-for[]" value="Family"> Family</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="suitable-for[]" value="Corporate">Corporate</label></div>
											</div>
										...
										<div class="col-md-3">
											...
											<div class="position-relative form-group">
												<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="suitable-for[]" value="Other"> Other</label></div>
											</div>
							...
							<div class="position-relative form-check"><input name="newProp" id="newProp" <?php if (@$property['status'] == 'New') {
																												echo "checked";
																											} ?> type="checkbox" class="form-check-input" value="1"><label for="newProp" class="form-check-label">Check if you want property tagged "New"</label></div>

							<div class="position-relative form-check"><input name="featuredProp" id="featuredProp" type="checkbox" class="form-check-input" <?php if (@$property['featured_property'] == 'yes') {
																																								echo "checked";
																																							} ?> value="1"><label for="featuredProp" class="form-check-label">Is this a featured property?</label></div>

							<div class="form-row">
								<div class="col-md-4">
									<div class="position-relative form-check"><input name="newProp" id="newProp" <?php if (@$property['status'] == 'New') {
																														echo "checked";
																													} ?> type="checkbox" class="form-check-input" value="1"><label for="newProp" class="form-check-label">Check if property is new</label></div>
								</div>
								...
								<div class="col-md-4">
									<div class="position-relative form-check"><input name="premiumProp" id="premiumProp" type="checkbox" class="form-check-input" <?php if (@$property['premium_property']) {
																																										echo "checked";
																																									} ?> value="1"><label for="premiumProp" class="form-check-label">Is this a premium property?</label></div>
								</div>
									...
									<div data-parent="#accordion" id="collapseOne1" aria-labelledby="headingOne" class="collapse show">
										...
										<div class="card-body">
											...
											<div class="position-relative form-group"><label for="payment-plan" class="">Payment Plan</label><select name="payment-plan" id="payment-plan" class="payment-plan form-control">
													...
													<option <?php if ($property['paymentPlan'] == 'flexible') {
																echo 'selected="selected"';
															} ?> value="flexible">Flexible</option>

													<option <?php if ($property['paymentPlan'] == 'upfront') {
																echo 'selected="selected"';
															} ?> value="upfront">Upfront</option>
												...
												<div class="col-md-6">
													...
													<div class="position-relative form-group">
														...
														<select name="security-deposit-term" id="security-deposit-term" class="form-control">
															...
															<option <?php if ($property['securityDepositTerm'] == 1) {
																		echo 'selected="selected"';
																	} ?> value="1">One Year</option>

															<option <?php if ($property['securityDepositTerm'] == 2) {
																		echo 'selected="selected"';
																	} ?> value="2">Two Years</option>
										...
										<div class="card-body">
											...
											<div class="form-row">
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" name="amenities[]" <?php if (in_array("water", $amenity)) {
																																																			echo 'checked="checked"';
																																																		} ?> value="water">Water</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("wardrobe", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="wardrobe">Wardrobe</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("dining", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="dining"> Dining</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("prepaid-electricity", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="prepaid-electricity">Prepaid Electricity</label></div>
													</div>
											...
											<div class="form-row">
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("security-gate", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="security-gate">Security Gate</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("pool", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="pool">Pool</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("gym", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="gym">Gym</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("wifi", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="wifi">WIFI</label></div>
													</div>
												...
												<div class="col-md-3">
													...
													<div class="position-relative form-group">
														<div class="position-relative form-check"><label class="form-check-label"><input type="checkbox" class="form-check-input" <?php if (in_array("generator", $amenity)) {
																																														echo 'checked="checked"';
																																													} ?> name="amenities[]" value="generator">Gen</label></div>
													</div>
								...
								<div class="card">
									...
									<div id="headingFour" class="card-header">
										...
										<button type="button" data-toggle="collapse" data-target="#collapseOne4" aria-expanded="false" aria-controls="collapseFour" class="text-left m-0 p-0 btn btn-link btn-block">
											<h5 class="m-0 p-0">Property Extra Note</h5>
										</button>
								...
								<div class="card">
									...
									<div id="headingFive" class="card-header">
										...
										<button type="button" data-toggle="collapse" data-target="#collapseOne5" aria-expanded="false" aria-controls="collapseFive" class="text-left m-0 p-0 btn btn-link btn-block">
											<h5 class="m-0 p-0">Neighborhood</h5>
										</button>
									...
									<div data-parent="#accordion" id="collapseOne6" class="collapse">
										...
										<div class="card-body">
											...
											<div id="uploaded_images">
												...
												?>
															<span class="imgCover removal-id-<?php echo $count; ?>" id="id-<?php echo $fileKey; ?>">
																<img src="<?php echo $fileUrl; ?>" id="<?php echo $fileKey; ?>" class="upldImg img-responsive img-thumbnail" onclick="selectFeatured(this.id)" title="Click to select as featured image" />
																<?php if ($fileKey == $property['featuredImg']) {
																	echo '<span class="featTT">Featured</span>';
																} ?>
																<div class="remove-img img-removal" id="img-properties-<?php echo $fileKey; ?>-<?php echo $count; ?>">remove <i class="fa fa-trash"></i></div>
															</span>
												<?php
														}
														$count++;
