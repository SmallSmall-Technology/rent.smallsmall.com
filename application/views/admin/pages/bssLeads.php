...
<!-- 
                        ...
                        <?php
                            ...
                            // }
                                ...
                                foreach($bssDistLeads as $bssDistLead => $value) {

                                $bssLeads = $this->admin_model->fetchbssLeads($value['referral']);

                                if ($bssLeads->num_rows() > 0) {
                        
                                foreach ($bssLeads->result() as $row) {
...
<!-- 
                        ...
                        <?php
                            ...
                            // }
                                ...
                                $bssLeads = $this->admin_model->fetchbssLeadsThisWeek($value['referral']);
                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <?php
                            ...
                            // }
                                ...
                                $bssLeads = $this->admin_model->fetchbssLeadsLastWeek($value['referral']);
