		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="main-card mb-3 card">
					...
					<div class="card-header"><?php //echo count($rss_users)." of ".$total_count; ?>
					...
					<div class="table-responsive">
						...
						<table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tr>
								<td class="text-left">
									<input type="checkbox" class="action-item" id="<?php echo $value['verification_id'].'-'.$value['user_id'].'-'.$value['email'] ?>" />
								</td>
								...
								<td class="text-left">
									<?php
										...
										}elseif($value['verified'] == 'failed'){
											echo '<div class="mb-2 mr-2 badge badge-danger">Failed</div>';
											
										}else{
											echo '<div class="mb-2 mr-2 badge badge-primary">'.$value['verified'].'</div>';
										}
									?>
								...
								<td class="text-left">
									...
									<button type="button" class="btn btn-primary btn-sm ver-detail"><a style="color:white;" href="<?php echo base_url()."admin/profile/".$value['verification_id']; ?>">Details</a></button>
