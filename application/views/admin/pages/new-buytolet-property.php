										...
										<div class="card-body">
											...
											<div class="form-row"> 
											    <div class="col-md-6">
                                                    ...
                                                    <input name="min_mortgage" id="min_mortgage" type="number" class="form-control allFields"></div>
												</div>

												<div class="col-md-6">
                                                    <div class="position-relative form-group"><label for="max_mortgage" class="">Max. Alt-Mortgage</label>
                                                    <input name="max_mortgage" id="max_mortgage" type="number" class="form-control allFields"></div>
												</div>
											...
											<div class="position-relative form-group">
												...
												<input name="rentPerAnnum" id="rentPerAnnum" placeholder="Rent Per Annum" type="text" class="form-control allFields">
											</div>
										</div>
									</div>
								</div>
