 								...
 								<?php
									...
									?>
 										...
 										<tr id="booking-<?php echo $value['refID']; ?>">
 											...
 											<!---<td class="text-left"><?php //echo '<a target="_blank" href="'.base_url().'apartment/'.$value['propertyID'].'">'.$value['property_name'].'</a>'; 
																		?></td>--->
 											<!--<td class="text-left"><?php //echo $value['city'].', '.$value['name'] 
																		?></td>
								<td class="text-left"><?php //echo $value['type'] 
														?></td>-->
 											<td class="text-left">
