 								...
 								<?php
									...
									?>
 										...
 										<tr>
 													...
 													<div class="widget-content-wrapper">
 														...
 														<div class="widget-content-left mr-3">
 															...
 															<div class="widget-content-left">
 																...
 																<div class="widget-subheading"><b>Account name:</b><?php echo $value['account_name']; ?> <?php //echo date('d M Y', strtotime($value['lastLogin'])); 
																																							?></div>
 															</div>
 											...
 											<td class="text-left"><span style="font-family:helvetica;">&#x20A6;</span><?php echo number_format($value['account_balance']) ?>
 					</div>
 					</td>
 					...
 					<tr class="deduction-line" id="deduction-line-<?php echo $value['userID']; ?>">
 						...
 						<td class="text-left">
 							<select id="deduction-purpose-<?php echo $value['userID']; ?>" name="deduction-purpose" class="form-control deduction-purpose">
 								...
 								<!-- // Adding Others, and get the admin others purpose for reduction -->
 								<option value="Others">Others</option>
 							</select>
 							<!-- Added Input Field To Get Custom Purpose for Reduction by Admin -->
 ...
 <!-- // Script added to detect changes and also get the others input values -->
