    <div class="container-fluid hero landlord">
        <div class="top-menu">
            <div class="top-menu-inner">
                <div class="logo-container"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="" /></div></div>
                <div class="navigation">
                    ...
                    <ul class="menu light">
                        <li class="menu-item"><a id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" href="#">Subscribe<i class="bx bx-chevron-down arrowbtn"></i></a>
                            <ul class="sub-menu dropdown-menu" aria-labelledby="dropdownMenuButton1">
        ...
        <div class="hero-header">
            <p class="hero-heading">Lease your property with no worries</p>
            <p class="hero-sub-text">Easier Management of your property as well as tenants who are verified and vetted by us to eliminate issues and stress.</p>
        </div>
