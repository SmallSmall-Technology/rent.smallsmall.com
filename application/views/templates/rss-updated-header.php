...
<head>
    ...
    ! function() {
      ...
      if (!analytics.initialize)
        if (analytics.invoked) window.console && console.error && console.error("Segment snippet included twice.");
          ...
          analytics._writeKey = "We4Ta0YZQaVqerD2AUTcMKhsj0y61eWV";;
  ...
  <script type="text/javascript">
    (function(f, b) {
      if (!b.__SV) {
        ...
        e.async = !0;
        e.src = "undefined" !== typeof MIXPANEL_CUSTOM_LIB_URL ? nMIXPANEL_CUSTOM_LIB_URL : "file:" === f.location.protocol && "//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js".match(/^\/\//) ? "https://cdn.mxpnl.com/libs/mixpanel-2-latest.min.js" : "//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js";
  ...
  <!-- Customer.io JavaScript snippet --->
  ...
  <!-- End Customer.io JavaScript snippet --->
    ...
    <nav id="navbar_top" class="navbar navbar-dark navbar-expand-lg text-black bg-white">
      ...
      <div class="login-btn">
        <div class="user_icon nav-item dropdown">
          <a class="nav-link dropdown-toggle dropdown-toggle--custom p-0 d-md-block d-none" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
          ...
          <a class="nav-link dropdown-toggle dropdown-toggle--custom p-0 d-md-none d-block" data-toggle="dropdown" role="button" aria-expanded="false">
            <!--<img src="<?php echo base_url(); ?>assets/updated-assets/images/users.svg" alt="users" />-->
            <?php echo (!@$userID) ? '<img src="' . base_url() . 'assets/updated-assets/images/users.svg" alt="users" />' : '<img src="' . base_url() . 'assets/updated-assets/images/users2.svg" alt="users" />'; ?>
          </a>
        ...
        <div class="menu_icon">
          <a class="d-md-block d-none nav-link text-dark dropdown-toggle dropdown-toggle--custom p-0" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
            <span class="menu_icon--text">Menu</span>
          </a>
          <a class="d-md-none d-block  nav-link text-dark dropdown-toggle dropdown-toggle--custom p-0" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
            <span class="menu_icon--text">Menu</span>
          </a>
          <div class="dropdown-menu menu_icon--dropdown p-0">
            ...
            <div class="menu-mobile p-4 d-md-none d-block">
              ...
              <div>
                ...
                <p><a class="text-white" href="https://dev-buy.smallsmall.com"><small class="font-weight-light" style="font-size:10px">Invest</small><br>BuySmallsmall</a> </p>
              </div>
              <div>
