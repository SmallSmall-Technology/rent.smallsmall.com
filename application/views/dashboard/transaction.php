...
<body>
    ...
    <header>
        ...
        <nav class="navbar d-flex menu-navbar-bg nav-mobile d-flex d-lg-none">
            ...
            <a href="href="<?php echo base_url(); ?>"" style="width: 33%" class="flex-grow-1 text-center">
                <img class="img-fluid" src="../assets/images/rss-logo.svg" alt="logo">
            </a>
            <div class="d-flex user-container">
                <div class="user-shorthand d-flex justify-content-center align-items-center mr-2">
    ...
    <div class="container-fluid d-flex justify-content-center nav-bottom-color">
        <div class="sub-nav d-flex flex-wrap">
            ...
            <a class="text-decoration-none secondary-text-color mr-4 py-3 dashboard-active" href="<?php echo base_url('dashboard/transaction'); ?>">
                <div class="sub-menu-link  ">
                    Transactions
                </div>
            </a>
    ...
    <script src="../assets/js/popper.min.js" integrity="" crossorigin="anonymous"></script>
    <script src="../assets/js/bootstrap-js/bootstrap.min.js" integrity="" crossorigin="anonymous"></script>
        ...
        $(document).ready(function(){
            ...
            function load_data(limit, start)
            {
                $.ajax({
                    ...
                    url:"<?php echo base_url(); ?>rss/fetchTransaction",
