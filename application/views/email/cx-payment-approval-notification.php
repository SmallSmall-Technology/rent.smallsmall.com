			...
			<tr>
				<td width="100%">
					<div class="message-container" style="width:100%;border-radius:10px;text-align:center;background:#F2FCFB;padding:40px;">
						<div style="width:100%;	min-height:10px;overflow:auto;text-align:center;font-family:calibri;font-size:30px;margin-bottom:20px;" class="name">Hi CX Team ,</div>
						...
						<div style="width:100%;min-height:30px;	overflow:auto;text-align:center;font-family:calibri;font-size:14px;margin-bottom:20px;" class="email-body">Payment has been confirmed and approved for <?php echo @$name; ?> at following property <a href="https://www.rentsmallsmall.com/property/<?php echo @$prop_id; ?>"><?php echo @$propertyName; ?></a></div> 
