                  ...
                  <div class="card default-background border-0">
                    <div class="card-body pb-5">
                      <div class="d-flex justify-content-between mb-2">
                        ...
                        <p class="custom-font-size-14 font-weight-light">Jan 15, 2023</p>
                      </div>
                      <div class="mt-3">
                        <p class="card-text" style="font-size: 18px; font-weight: 500;">Wall Collapse</p>
                        <p class="card-text" style="font-size: 12px">2 br Maisonette B2 Olivia Court Lekki</p>
