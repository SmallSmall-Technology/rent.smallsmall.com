			...
			<div class="txt-content">
				...
				<ul class="team-container teamProps">
					...
					<li class="team-item">
						...
						<div class="member-designation">Co Founder/VP Product & Data</div>
					</li>
					<li class="team-item">
					...
					<li class="team-item">
						<img src="<?php echo base_url('assets/images/team/tobi.png'); ?>" />
						<div class="member-name">Tobi Terry Olu</div>
						<div class="member-designation">Field Experience</div>
					</li>
					<li class="team-item">
						<img src="<?php echo base_url('assets/images/team/james_01.png'); ?>" />
						<div class="member-name">James Otache</div>
						<div class="member-designation">Accountant</div>
					</li>
					
					<li class="team-item">
						<img src="<?php echo base_url('assets/images/team/james-02.png'); ?>" />
						<div class="member-name">James Okpowo</div>
						<div class="member-designation">Facility Manager</div>
					</li>
					<li class="team-item">
					...
					<li class="team-item">
						...
						<div class="member-designation">Web Developer</div>
					</li>
