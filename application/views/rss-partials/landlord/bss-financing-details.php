                <div class="bss-button-container">
                    <div class="bss-mini-btn-container">
                        <div class="bss-top-btn"><a href="<?php echo base_url().''.$user_type.'/bss-unit/'.$unit['propertyID']; ?>">Property Portfolio</a></div>
                    </div>
                    <?php if($unit['plan'] == 'finance'){ ?>
                    <div class="bss-mini-btn-container">
                        <div class="bss-top-btn"><a class="active" href="<?php echo base_url().''.$user_type.'/finance-details/'.$unit['propertyID']; ?>">Financing</a></div>
                    </div>
                    <?php } ?>
                    <div class="bss-mini-btn-container">
                        <div class="bss-top-btn"><a href="<?php echo base_url().''.$user_type.'/payment-details/'.$unit['propertyID']; ?>">Payments</a></div>
                    </div>
                </div>
                    ...
                    <div class="financing-snippets finance-snippet">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="bss-finance-btn schedule-btn"><a href="#">Payment schedule</a></div>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                ...
                <div class="payment-schedule-pane">
