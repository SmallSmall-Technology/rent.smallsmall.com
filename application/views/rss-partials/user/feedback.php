                ...
                <div class="prop-rating-top"> 
                    <table>                            
                        <tr>
                            ...
                            <td>
                                <div class="dash-bt-header white-txt">Leave a feedback</div>
                    ...
                    <form method="POST" id="feedbackForm">
                        <div class="form-controls-container">
                            <div class="result-bar"></div>
                                <label>How satisfied are you using out services?</label>
                        ...
                        <div class="form-controls-container">
                            <label>Rate our porducts and services</label>
                            <div class="survey-option-container">
                        ...
                        <div class="form-controls-container">
                            <label>Do you have suggestions on how to improve our services?</label>
                            <textarea rows="10" id="feedback-note" class="txtarea-survey"></textarea>
                        </div>
                        <input type="hidden" id="satisfaction-value" value="" />
                        <input type="hidden" id="grade-value" value="" />
                        <div class="form-controls-container">
                            <input type="submit" class="action-btns green-bg feedback-btn" value="Submit">
                        </div>
