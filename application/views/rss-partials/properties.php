...
<head>
  ...
  <!--Benifit App Platform authomation pop message for users interaction -->
...
<!--End of Record Script-->
  ...
  <!--Segment App platform script to monitor visitors on the site-->

<script>
  !function(){var analytics=window.analytics=window.analytics||[];if(!analytics.initialize)if(analytics.invoked)window.console&&console.error&&console.error("Segment snippet included twice.");else{analytics.invoked=!0;analytics.methods=["trackSubmit","trackClick","trackLink","trackForm","pageview","identify","reset","group","track","ready","alias","debug","page","once","off","on","addSourceMiddleware","addIntegrationMiddleware","setAnonymousId","addDestinationMiddleware"];analytics.factory=function(e){return function(){if(window.analytics.initialized)return window.analytics[e].apply(window.analytics,arguments);var i=Array.prototype.slice.call(arguments);i.unshift(e);analytics.push(i);return analytics}};for(var i=0;i<analytics.methods.length;i++){var key=analytics.methods[i];analytics[key]=analytics.factory(key)}analytics.load=function(key,i){var t=document.createElement("script");t.type="text/javascript";t.async=!0;t.src="https://cdn.segment.com/analytics.js/v1/" + key + "/analytics.min.js";var n=document.getElementsByTagName("script")[0];n.parentNode.insertBefore(t,n);analytics._loadOptions=i};analytics._writeKey="We4Ta0YZQaVqerD2AUTcMKhsj0y61eWV";;analytics.SNIPPET_VERSION="4.16.1";
  analytics.load("We4Ta0YZQaVqerD2AUTcMKhsj0y61eWV");
  analytics.page();
  }}();
</script>
    
   <!--Benifit App Platform authomation pop message-->
...
<!--End of Record Script-->
  ...
  <!-- Other FAQ CSS-->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/updated-assets/css/custom-css/apartmentPolicy.css" />
      ...
      <div class="login-btn">
        <div class="user_icon nav-item dropdown">
          <a class="nav-link dropdown-toggle dropdown-toggle--custom p-0 d-md-block d-none" data-toggle="dropdown"
            ...
            <?php echo (!@$userID) ? '<img src="' . base_url() . 'assets/updated-assets/images/users.svg" alt="users" />' : '<img src="' . base_url() . 'assets/updated-assets/images/users2.svg" alt="users" />'; ?>
          </a>
        ...
        <div class="dropdown-menu user_icon--dropdown desktopDropdown p-0">
            ...
            <div class="d-md-block d-none">
              ...
              <?php if (@$userID && !@$ongod && @$user_type == 'tenant') { ?>
                <!-- Desktop view for users that do not have a wallet-->
                <!--- Tenant button ---->
                <div class="mb-2">
                  <div class="px-3 py-3">
                    <a class="dropdown-item d-flex align-items-end " href="<?php echo base_url('dashboard/index'); ?>">
                  ...
                  <div class="px-3 py-3">
                    <?php if (@!$account_details) { ?>
                      <a class="dropdown-item d-flex align-items-end " href="<?php echo base_url('dashboard/wallet')?>">
                        <!-- <i class="fa-solid fa-chart-column">&nbsp;&nbsp;</i> -->
                    ...
                    <?php } else { ?>
                      ...
                      <div class="dropdown-item d-flex align-items-start ">
                        ...
                        <div class="d-flex align-items-start">
                          ...
                          <a href="<?php echo base_url('dashboard/wallet')?>" class="btn primary-background">Top up</a>
                        </div>
                      </div>
                  ...
                  <div class="dropdown-divider m-0"></div>
                  <div class="px-3 py-3">
                    <a class="dropdown-item d-flex align-items-end " href="<?php echo base_url('logout'); ?>">
                      <!-- <i class="fa-solid fa-chart-column">&nbsp;&nbsp;</i> -->
              ...
              <?php } else { ?>
                <!-- Desktop view for users login and create account-->
                <div class="mb-2">
                  <div class="px-3 py-3">
                    <a class="dropdown-item d-flex align-items-end " href="<?php echo base_url('login'); ?>">
                      <!-- <i class="fa-solid fa-chart-column">&nbsp;&nbsp;</i> -->
                  ...
                  <div class="dropdown-divider m-0"></div>
                  <div class="px-3 py-3">
                    <a class="dropdown-item d-flex align-items-end " href="<?php echo base_url('signup'); ?>">
                      <!-- <i class="fa-solid fa-chart-column">&nbsp;&nbsp;</i> -->
            ...
            <!-- mobile view for login and create account -->
            ...
            <div class="d-md-none d-block">
              <div class="mobileDropdown">
                ...
                <div class="px-3 py-4">
                  <a class="dropdown-item " href="<?php echo base_url('dashboard/wallet')?>">
                ...
                <div class="px-3 py-4">
                  <div class="dropdown-item d-flex align-items-end flex-wrap" href="#">
                    ...
                    <a href="<?php echo base_url('dashboard/wallet')?>" class="btn primary-background ml-1 py-1 px-1">Top up</a>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="row">
            ...
            <div class="col-md-12 d-md-none d-flex flex-column align-items-center mb-5">
              ...
              <div class="d-flex font footer-social-media">
                <a target="_blank" href="https://twitter.com/smallsmall_tech" class="text-white mr-3">
                  <i class="fa-brands fa-twitter"></i>
                </a>
                <a target="_blank" a href="https://www.instagram.com/smallsmall.tech" class="text-white mr-3">
                  <i class="fa-brands fa-instagram"></i>
                </a>
                <!--<a target="_blank" a href="#" class="text-white mr-3">-->
                <!--  <i class="fa-brands fa-facebook"></i>-->
                <!--</a>-->
                <a target="_blank" href="https://www.linkedin.com/company/small-small-technology"
        ...
        <div class="col-md-6 ">
          <div class="row">
              ...
              <div class="row mb-4">
                <div class="col-md-4 col-6 mb-4">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link pl-0 text-white" href="<?php echo base_url(); ?>">
                        Rent
                      </a>
                    </li>
                    <!-- <li class="nav-item">
                ...
                <div class="col-md-4 col-6 mb-4">
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link pl-0 text-white" href="<?php echo base_url('terms-of-use'); ?>">
                        Terms Of Use
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link pl-0 text-white" href="<?php echo base_url('faq'); ?>">FAQ</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-md-12 mb-5">
              ...
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link pl-0 text-white d-flex flex-wrap" href="mailto:customerexperience@smallsmall.com"
                    target="_blank">
                    <i class="fa-solid fa-envelope mr-3"></i>
                    <span>customerexperience@smallsmall.com</span>

                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-0 text-white d-flex flex-wrap" href="tel:+23409036339800">
                    <i class="fa-solid fa-phone mr-3"></i>
                    <span>0903 633 9800 &nbsp;&nbsp;0903 722 2669</span>
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div class="col-md-3 ">
          <div class="row">
            ...
            <div class="col-md-12 mt-4 footer-apps-container">
              <h6>Download the Mobile App</h6>
              <div class="footer-apps d-flex">
                <div class="footer-apps-child">
                  <a href="https://play.google.com/store/apps/details?id=com.smallsmall.mobile&pli=1">
                    <img src="<?php echo base_url(); ?>assets/updated-assets/images/googleplay.svg" class=" img-fluid my-2" alt="" />
                  </a>
                  <a href="https://apps.apple.com/us/app/smallsmall/id1643608622">
                    <img src="<?php echo base_url(); ?>assets/updated-assets/images/appstore.svg" class=" img-fluid my-2" alt="" />
                  </a>
                </div>
