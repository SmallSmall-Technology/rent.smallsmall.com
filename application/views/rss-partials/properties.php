...
<!--<div id="filter-section-container">-->
    <div class="row my-5 filter-section d-lg-flex d-none">
        ...
        <div class="dropdown">
          <button class="btn  dropdown-toggle py-2 filter-btn web-load" type="button" data-toggle="dropdown"
            aria-expanded="false">
            location
          </button>
          <div class="dropdown-menu p-3 mt-3 filter-section-dropdown">
          ...
          <div class="card" id="properties-container">
            ...
            <div class="card-body">
              ...
              <div class="card-text d-flex justify-content-between">
                ...
                <a href="#" class="text-decoration-none" onclick="shareLink()" data-toggle="tooltip" data-placement="top" title="Share property link">
                  <div class="d-flex flex-column  align-items-center">
          ...
          if (Array.isArray(response)) {
            $.each(response, function(index, location) {
              const locationBtn = $('<button></button>')
                ...
                .css({ display: 'inline-block', width: '110px' })
                .text(location.name);
    ...
    var init = function () {                
        ...
        var mobileSlider = new rSlider({
            ...
            onChange: function (valses) {
                $('.price-range').val(valses);
            }
        });
        
        // Separate the sliders' pointers
        slider._pos[1] = 50; // Adjust the position of the second pointer (0-100)
        slider._updatePos();
        mobileSlider._pos[1] = 50; // Adjust the position of the second pointer (0-100)
        mobileSlider._updatePos();
    };
