				...
				<div class="main-card mb-3 card">
						...
						<div class="btn-actions-pane-right">
                            ...
                            <li class="nav-item">
                                <a role="tab" class="nav-link active" data-toggle="modal" data-target="#exampleModalLong">
                                    <span>Add Description <i style="font-size:14px;marginleft:5px;" class="fa fa-plus"></i></span>
                                </a>
                            </li> 	
                        </ul>
						</div>
					...
					<div class="table-responsive">
						<table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tbody>
							<?php
								if (isset($distances) && !empty($distances)) {
									foreach($distances as $distance => $value) {
							?>	

							<tr>
						
								<td class="text-left"><?php echo $value['distance'] ?></td>
