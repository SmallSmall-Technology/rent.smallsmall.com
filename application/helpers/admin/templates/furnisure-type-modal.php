    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!--- Ends Here --->
                <form id="furnisureType" method="POST">
                   	<div class="position-relative form-group"><label for="category">Type</label>
    					<input name="type" id="type" type="text" class="form-control float-txt">
    				</div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <input type="submit" class="btn btn-primary amenity-but" value="Upload Type">
                </div>
            </form>
        </div>
    </div>
