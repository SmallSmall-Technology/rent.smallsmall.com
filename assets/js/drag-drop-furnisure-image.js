...
$('.file_drag_area').on('drop', function(e){
	...
	var files = $('.identification')[0].files;
	...
	if(error == ''){
	   ...
	   $.ajax({
			...
			url:baseUrl+"admin/uploadFurnisureImages/"+folderName, //base_url() return http://localhost/tutorial/codeigniter/
