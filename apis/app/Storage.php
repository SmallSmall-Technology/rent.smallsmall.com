...
class Storage extends Model implements Payable
{
    ...
    {
        if($this->isRented()){
            $this->pre_payment_errors =  ['error' => 'This Storage is not available for rent'];
        }
    ...
    static function get_images($storage){
